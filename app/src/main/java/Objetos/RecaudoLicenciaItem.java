 ...
 */
public class RecaudoLicenciaItem {
    ...
    public RecaudoLicenciaItem() {
    }

    public RecaudoLicenciaItem(long codigo, long codigo_cliente, String nombre, String direccion, String barrio, long saldo_lic, long recibo_venta, String fecha_venta, long codigo_vendedor, long codigo_cobrador, long precio_venta, String observacion_recaudo, long valor_pagado, long recibo_generado, String fecha_cobro, String fecha_export, String nombre_vendedor, String nombre_cobrador, int num_lics, int producto, String dias_cobro, long codigo_venta, boolean cobrado, String categoria, String tipo_vehiculo) {
        this.codigo = codigo;
        this.codigo_cliente = codigo_cliente;
        this.nombre = nombre;
        this.direccion = direccion;
        this.barrio = barrio;
        this.saldo_lic = saldo_lic;
    ...
    public long getSaldo_lic() {
        return saldo_lic;
    }

    public void setSaldo_lic(long saldo_lic) {
        this.saldo_lic = saldo_lic;
    }
    ...
    public void setNum_lics(int num_lics) {
        this.num_lics = num_lics;
    }
