...
import CustomAdapters.ListSoatAdapter;
...
public class RecaudoSoatActivity extends AppCompatActivity {

    int cliente_seleccionado;
    DaoRecaudoSoat daoRec = new DaoRecaudoSoat();
    DaoRecaudo daoRecN = new DaoRecaudo();
    DaoTransacciones daoTrans = new DaoTransacciones();
    List<RecaudoSoatListItem> ClienteSelected = new ArrayList<>();
    long num_recibo = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recaudo_soat);

        mContext = getApplicationContext();
        session = new ManejadorSession(mContext);
        mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();

        TextView noteView = (TextView) findViewById(R.id.lblVerDetallesSoat);
        Linkify.addLinks(noteView, Linkify.ALL);

        //INICIALIZAR CONTROLES DE LAYOUT
        txtCliente = (EditText)findViewById(R.id.txtClienteRSoat);
        txtDireccion = (EditText)findViewById(R.id.txtDireccionRSoat);
        txtBarrio = (EditText)findViewById(R.id.txtBarrioRSoat);
        txtNumLineas = (EditText)findViewById(R.id.txtNumSoat);
        txtSaldoTotal = (EditText)findViewById(R.id.txtSaldoTotalRSoat);
        txtAPagar = (EditText)findViewById(R.id.txtValorPagarRSoat);
        txtObservaciones = (EditText)findViewById(R.id.txtObservacionesRSoat);
        btnPagar = (Button)findViewById(R.id.btnPagarSoat);
    ...
    class LoadCiente extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RecaudoSoatActivity.this);
            ...
            runOnUiThread(new Runnable()
            {
                public void run()
                {
                    ...
                    if (ClienteSelected.size()>0)
                    {
                        ...
                        int sum = 0;
                        for (RecaudoSoatListItem rli:ClienteSelected)
                        {
                            sum += rli.getSaldo_soat();
                        }
                    ...
                    {
                        Toast.makeText(RecaudoSoatActivity.this,"Por favor vuelva a seleccionar el cliente...!"+ClienteSelected.size(),Toast.LENGTH_SHORT).show();
                    }
    ...
    public void MostrarModal()
    {
        ...
        pDialog = new Dialog(RecaudoSoatActivity.this);
        ...
        ListSoatAdapter lla = new ListSoatAdapter
                (RecaudoSoatActivity.this,R.layout.linea_row, ((ArrayList) ClienteSelected));
                        ...
                        if (session.GetPrinterMac() != null) {
                            ...
                            if (mBluetoothAdapter.isEnabled()) {
                                ...
                                final AlertDialog.Builder builder =
                                        new AlertDialog.Builder(RecaudoSoatActivity.this);
    ...
    private void SendData() throws IOException
    {
        try {
            ...
            for (int i =0; i<ClienteSelected.size(); i++)
            {
                CalculoCliente cc =
                        new CalculoCliente(ClienteSelected.get(i).getCodigo(),
                                ClienteSelected.get(i).getSaldo_soat(),
                                ClienteSelected.get(i).getSaldo_soat() -
                                        ClienteSelected.get(i).getValor_pagado(),
                                ClienteSelected.get(i).getValor_pagado(),
                                ClienteSelected.get(i).getPlaca(),
                                ClienteSelected.get(i).getPoliza(),
            ...
            printer = new Impresion(mContext,RecaudoSoatActivity.this);
    ...
    class SaveRecaudo extends AsyncTask<String, String, String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null) {
                Toast.makeText(RecaudoSoatActivity.this,
                        "Recaudo actualizado correctamente..!", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(RecaudoSoatActivity.this, "Recaudo no realizado a la linea: "
    ...
    class CalculoCliente
    {
        ...
        public CalculoCliente(long codigo, long debe, long nuevo_saldo, long paga, String placa, String poliza,
